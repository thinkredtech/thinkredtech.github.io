  ...
  const technologies = [
    {
      ...
      techs: [
        ...
        { name: "Next.js", icon: <SiNextdotjs className="w-10 h-10 text-[#000000]" /> },
        { name: "TailwindCSS", icon: <SiTailwindcss className="w-10 h-10 text-[#06B6D4]" /> },
    ...
    },
    {
      ...
      techs: [
        ...
        { name: "Express", icon: <SiExpress className="w-10 h-10 text-[#000000]" /> },
        { name: "NestJS", icon: <SiNestjs className="w-10 h-10 text-[#E0234E]" /> },
        { name: "Python", icon: <FaPython className="w-10 h-10 text-[#3776AB]" /> },
        { name: "FastAPI", icon: <SiFastapi className="w-10 h-10 text-[#009688]" /> },
        { name: "Spring Boot", icon: <SiSpringboot className="w-10 h-10 text-[#6DB33F]" /> }
      ]
    },
    {
      category: "DevOps & Cloud",
      techs: [
        { name: "Docker", icon: <FaDocker className="w-10 h-10 text-[#2496ED]" /> },
        { name: "Kubernetes", icon: <SiKubernetes className="w-10 h-10 text-[#326CE5]" /> },
        { name: "AWS", icon: <FaAws className="w-10 h-10 text-[#FF9900]" /> },
        { name: "GitHub Actions", icon: <FaGithub className="w-10 h-10 text-[#2088FF]" /> },
