...
const Testimonials: React.FC = () => {
  const testimonials = [
    {
      quote: "ThinkRED Technologies transformed our digital infrastructure, delivering a solution that exceeded our expectations in both functionality and user experience.",
    ...
    {
      quote: "Working with ThinkRED has been a game-changer for our development workflow. Their expertise in DevOps and infrastructure automation has significantly improved our deployment process.",
      author: "Michael Chen",
    ...
    {
      quote: "The team at ThinkRED brought both technical excellence and creative thinking to our project. They truly understand how to simplify complex technology challenges.",
      author: "Priya Sharma",
            ...
            >
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-secondary">{testimonial.position}, {testimonial.company}</p>
                </div>
              </div>
            </div>
          ))}
