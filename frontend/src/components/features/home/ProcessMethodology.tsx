...
const ProcessMethodology = () => {
  ...
  const { elementRef: timelineRef, isInView: timelineVisible } = useScrollAnimation();
  const { elementRef: desktopStepsRef, visibleItems: visibleSteps } = useStaggeredAnimation(4, 300);
  const { elementRef: principlesRef, isInView: principlesVisible } = useScrollAnimation();
  const methodologies = [
    {
      phase: '01',
      ...
      activities: ['Architecture Assessment', 'Stakeholder Alignment', 'Technology Audit', 'Strategic Planning'],
      icon: (
    ...
    },
    {
      ...
      activities: ['System Design', 'API Architecture', 'Security Framework', 'Scalability Planning'],
      icon: (
        <svg className="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      activities: ['Sprint Planning', 'Continuous Integration', 'Code Reviews', 'Quality Assurance'],
      icon: (
        <svg className="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      activities: ['DevOps Pipeline', 'Performance Tuning', 'Knowledge Transfer', 'Ongoing Support'],
      icon: (
        <svg className="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="py-16 md:py-24 bg-backgroundAlt">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="heading-1 mb-4 text-secondary">Our Process & Methodology</h2>
          <p className="text-secondary max-w-4xl mx-auto">
            We follow a proven, iterative methodology that combines enterprise best practices with agile principles,
            ensuring successful delivery while maintaining flexibility and continuous value creation throughout your
        ...
        >
          ...
          <div className="hidden lg:block">
                ...
                <div key={index} className="flex-1 relative">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center mb-4 relative z-10">
                      <span className="text-white font-bold text-lg">{methodology.phase}</span>
                    </div>
            ...
            {/* Phase Details */}
            <div ref={desktopStepsRef as React.RefObject<HTMLDivElement>} className="grid grid-cols-4 gap-8">
              {methodologies.map((methodology, index) => (
                <div
                  key={index}
                ...
                >
                  <div className="bg-backgroundAlt rounded-lg p-6 hover:shadow-lg transition-all duration-300 group">
                    ...
                    <p className="text-secondary mb-4 text-sm leading-relaxed">{methodology.description}</p>
                    <div className="space-y-2">
                      {methodology.activities.map((activity, activityIndex) => (
                        <div key={activityIndex} className="flex items-center justify-center">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1 bg-backgroundAlt rounded-lg p-6">
                      <div className="flex items-center mb-3">
                        {methodology.icon}
                        <h3 className="heading-2 text-dark ml-3">{methodology.title}</h3>
                      </div>
                      <p className="text-secondary mb-4 leading-relaxed">{methodology.description}</p>
                      <div className="grid grid-cols-2 gap-2">
                        {methodology.activities.map((activity, activityIndex) => (
                          <div key={activityIndex} className="flex items-center">
                            <div className="w-1 h-1 bg-primary rounded-full mr-2"></div>
                            <span className="text-sm text-dark font-medium">{activity}</span>
                          </div>
                        ))}
                      </div>
                    </div>
        ...
        <div
          ...
          className={`bg-primary/5 rounded-lg p-8 md:p-12 transition-all duration-1000 ease-out ${
            principlesVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
          }`}
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="heading-1 text-dark mb-6">Core Methodology Principles</h3>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h4 className="font-semibold text-dark mb-1">Collaborative Approach</h4>
                    <p className="text-secondary text-sm">
                      Deep partnership with your team ensuring knowledge transfer and sustainable solutions
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h4 className="font-semibold text-dark mb-1">Risk Mitigation</h4>
                    <p className="text-secondary text-sm">
                      Proactive identification and management of technical and business risks
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h4 className="font-semibold text-dark mb-1">Continuous Value Delivery</h4>
                    <p className="text-secondary text-sm">
                      Regular deliverables and feedback loops ensuring continuous value creation
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h4 className="font-semibold text-dark mb-1">Quality & Performance Focus</h4>
                    <p className="text-secondary text-sm">
                      Enterprise-grade quality standards with performance optimization built-in
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-white rounded-lg shadow-regular p-6">
                <h4 className="font-bold text-dark mb-4 text-center">Delivery Excellence</h4>
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <div className="heading-1 text-primary mb-1">Quality</div>
                    <div className="text-xs text-secondary">Focused Delivery</div>
                  </div>
                  <div>
                    <div className="heading-1 text-primary mb-1">Client</div>
                    <div className="text-xs text-secondary">Satisfaction Focus</div>
                  </div>
                  <div>
                ...
                <div className="mt-6 pt-4 border-t border-gray-100">
                  <div className="text-center">
                    ...
                    <div className="flex justify-center space-x-2 text-xs">
                      <span className="bg-primary/10 text-primary px-2 py-1 rounded">Agile</span>
                      <span className="bg-primary/10 text-primary px-2 py-1 rounded">DevOps</span>
                      <span className="bg-primary/10 text-primary px-2 py-1 rounded">Cloud</span>
                    </div>
                  </div>
                </div>
              </div>
