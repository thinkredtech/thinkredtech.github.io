...
export const useSEO = (config: SEOConfig) => {
  useEffect(() => {
    ...
    updateMetaProperty('og:image', config.image || '/assets/logos/thinkRED-og-image.png');
    ...
    updateMetaProperty('twitter:image', config.image || '/assets/logos/thinkRED-og-image.png');

    // Article specific tags (for blog posts)
    if (config.type === 'article') {
      updateMetaProperty('article:author', config.author || 'ThinkRED Technologies');
    ...
    return () => {
      ...
      document.title = 'ThinkRED Technologies | Simplify Technology & Experience';
    };
  }, [config]);
};
...
export const useStructuredData = (data: StructuredData) => {
  useEffect(() => {
    ...
    const existing = document.getElementById(`structured-data-${data['@type']}`);
    if (existing) {
      existing.remove();
    }
    ...
    return () => {
      const scriptElement = document.getElementById(`structured-data-${data['@type']}`);
      if (scriptElement) {
...
export const SEOConfigs = {
  ...
  about: {
    title: 'About ThinkRED Technologies | Engineering Excellence & Innovation Leaders',
    description:
  ...
  services: {
    title: 'Our Services | Web Development, Mobile Apps, DevOps, Platform Engineering & Technology Consulting',
    description:
  ...
  portfolio: {
    title: 'Our Portfolio | Successful Web Development Projects & Technology Solutions Case Studies',
    description:
  ...
  careers: {
    title: 'Careers at ThinkRED Technologies | Join Our Engineering Team - Remote & Hybrid Opportunities',
    description:
  ...
  blog: {
    title: 'ThinkRED Blog | Technology Insights, Web Development Tutorials & Engineering Best Practices',
    description:
  ...
  contact: {
    title: 'Contact ThinkRED Technologies | Get Your Project Started - Free Consultation & Quote',
    description:
...
export const StructuredDataSchemas = {
  ...
  website: {
    ...
    url: 'https://thinkred.tech',
    description: 'Expert web development, platform engineering, and technology consultation services.',
    publisher: {
      '@type': 'Organization',
      name: 'ThinkRED Technologies LLP',
    },
  ...
  article: (article: {
    ...
    image: article.image || 'https://thinkred.tech/assets/logos/thinkRED-og-image.png',
    url: article.url,
