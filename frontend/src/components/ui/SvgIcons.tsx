...
export const ContactIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
...
export const ServicesIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const PortfolioIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const BlogIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const CareerIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const AboutIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const WebDevIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const PlatformIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const DevOpsIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const TechIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const ArticleIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const InsightIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const QuoteIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const LearnIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const BuildIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const TheaterIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const SleepIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${getIconSize(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const ReactIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
    ...
    <ellipse cx="12" cy="12" rx="8.5" ry="3" fill="none" stroke="currentColor" strokeWidth="1" />
    <ellipse
      cx="12"
      cy="12"
      rx="8.5"
...
export const VueIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
    <path d="M2 3l10 18L22 3h-4l-6 10.6L6 3H2zm18 0l-8 14.4L4 3h2l6 10.6L18 3h2z" />
  </svg>
);

export const AngularIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
...
export const NodeIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
...
export const PythonIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
...
export const JavaIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
...
export const GoIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
...
export const TypeScriptIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
...
export const DockerIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
...
export const PostgreSQLIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
...
export const MongoDBIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
...
export const AWSIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${getIconSize(size)} ${className}`} viewBox="0 0 24 24" fill="currentColor">
