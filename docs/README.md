...
| -------------------------------------------------------- | -------------------------------------- | --------------------------- |
| [DEVELOPMENT.md](./developer/guides/development.md)                       | Local development setup and workflow   | Developers                  |
| [ARCHITECTURE.md](./developer/architecture/system-overview.md)                     | Technical architecture overview        | Developers, Technical leads |
| [API.md](./developer/apis/backend-apis.md)                                       | Backend API documentation              | Frontend developers         |
| [DEPLOYMENT.md](./developer/deployment/production.md)                         | Deployment processes and CI/CD         | DevOps, Developers          |
...
| Document                                             | Purpose                        | Audience           |
| ---------------------------------------------------- | ------------------------------ | ------------------ |
| [ENVIRONMENT.md](./developer/setup/environment.md)                   | Environment configuration      | Developers, DevOps |
| [TROUBLESHOOTING.md](./developer/setup/troubleshooting.md)           | Common issues and solutions    | Developers         |
...
| [CONTRIBUTING.md](./developer/guides/contributing.md) | Contribution guidelines                | Contributors |
| [STYLE_GUIDE.md](./developer/guides/code-style.md)   | Code style and conventions             | Developers   |

## Getting Started

For new developers, we recommend starting with:

1. **[DEVELOPMENT.md](./developer/guides/development.md)** - Complete setup instructions
2. **[ARCHITECTURE.md](./developer/architecture/system-overview.md)** - Understanding the system
3. **[API.md](./developer/apis/backend-apis.md)** - Backend integration details
...
Please see [CONTRIBUTING.md](./developer/guides/contributing.md) for detailed information about:
...
| ------------------------------------------ | ----------- | --------------------- |
| [🚢 Deployment Guide](./developer/deployment/production.md)     | 10 min      | Production deployment |
| [🔧 Troubleshooting](./developer/setup/troubleshooting.md) | 5 min       | Fixing issues quickly |
...
3. **[🚀 Setup Guide](./developer/setup/installation.md)** - Follow the lightning setup
4. **[🔧 Troubleshooting](./developer/setup/troubleshooting.md)** - When things go wrong

### **💻 Frontend Developer**

Focusing on UI/UX development:

1. **[🚀 Setup Guide](./developer/setup/installation.md)** - Frontend-only setup
2. **[🏗️ Architecture](./developer/architecture/system-overview.md)** - Frontend architecture section
3. **[📝 Style Guide](./developer/guides/code-style.md)** - React & TypeScript conventions
...
1. **[📡 API Reference](./developer/apis/backend-apis.md)** - Complete API documentation
2. **[🌍 Environment Management](./developer/setup/environment.md)** - Backend configuration
3. **[🚢 Deployment Guide](./developer/deployment/production.md)** - Backend deployment
4. **[📝 Style Guide](./developer/guides/code-style.md)** - Google Apps Script conventions

### **🚀 DevOps Engineer**

Managing deployment and infrastructure:

1. **[🚢 Deployment Guide](./developer/deployment/production.md)** - Full deployment process
2. **[🌍 Environment Management](./developer/setup/environment.md)** - Configuration management
3. **[🔧 Troubleshooting](./developer/setup/troubleshooting.md)** - Production issues
4. **[🏗️ Architecture](./developer/architecture/system-overview.md)** - System architecture
...
2. **[🏗️ Architecture](./developer/architecture/system-overview.md)** - System design & roadmap
...
- **[🚀 Setup Guide](./developer/setup/installation.md)** - Complete setup instructions
- **[🌍 Environment Management](./developer/setup/environment.md)** - Configuration details
- **[❓ FAQ](./FAQ.md)** - Setup troubleshooting

### **💻 Development**

- **[🎯 Workflow](./WORKFLOW.md)** - Development process
- **[📝 Style Guide](./developer/guides/code-style.md)** - Coding standards
- **[🏗️ Architecture](./developer/architecture/system-overview.md)** - System understanding

### **🐛 Debugging & Troubleshooting**

- **[🔧 Troubleshooting](./developer/setup/troubleshooting.md)** - Issue resolution
- **[❓ FAQ](./FAQ.md)** - Common problems
- **[📡 API Reference](./developer/apis/backend-apis.md)** - API debugging

### **🚢 Deployment**

- **[🚢 Deployment Guide](./developer/deployment/production.md)** - Production deployment
- **[🌍 Environment Management](./developer/setup/environment.md)** - Environment setup
- **[🔧 Troubleshooting](./developer/setup/troubleshooting.md)** - Deployment issues

### **🤝 Contributing**

- **[🤝 Contributing](./developer/guides/contributing.md)** - Contribution process
- **[📝 Style Guide](./developer/guides/code-style.md)** - Code standards
