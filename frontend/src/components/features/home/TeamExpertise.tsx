...
const TeamExpertise = () => {
  const { elementRef: headerElement, isInView: headerVisible } = useScrollAnimation();
  const { elementRef: expertiseElement, visibleItems: visibleExpertise } = useStaggeredAnimation(6, 200);
  const { elementRef: valuePropElement, isInView: valuePropVisible } = useScrollAnimation();
  ...
  const expertiseAreas = [
    ...
    },
    {
      ...
      highlights: ['SaaS Platform Design', 'Microservices Architecture', 'System Scalability', 'Technical Strategy'],
    },
    {
      icon: <CloudIcon />,
      ...
      highlights: ['AWS & Kubernetes', 'OpenShift Expertise', 'Infrastructure as Code', 'Serverless Architecture'],
    },
    {
      icon: <DevOpsIcon />,
      ...
      highlights: ['CI/CD Excellence', 'Workflow Automation', 'Developer Experience', 'Quality Engineering'],
    },
    {
      icon: <OpenSourceIcon />,
      ...
      highlights: ['Platform Development', 'Community Building', 'Certification Programs', 'Global Contributions'],
    },
    {
      icon: <AIIcon />,
      title: 'AI & Innovation',
      ...
      highlights: ['AI Integration', 'Legacy Modernization', 'Innovation Strategy', 'Emerging Technologies'],
    },
  ];
  ...
  return (
    <section className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="heading-1 mb-4 text-secondary">Team Expertise & Value Proposition</h2>
          <p className="max-w-4xl mx-auto text-secondary">
            Our leadership team brings together decades of enterprise experience, open-source expertise, and proven
            track records in scaling technology solutions across global organizations. We combine technical excellence
          ...
          {expertiseAreas.map((area, index) => (
            <div
              ...
              className={`bg-white rounded-lg shadow-regular hover:shadow-lg transition-all duration-700 p-6 group ${
                visibleExpertise.includes(index) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
              style={{
            ...
            >
              ...
              {/* Description */}
              <p className="text-secondary mb-6 leading-relaxed">{area.description}</p>
              ...
              <div className="space-y-2">
                {area.highlights.map((highlight, highlightIndex) => (
                  <div key={highlightIndex} className="flex items-center">
                    ...
                    <span className="text-sm text-secondary font-medium">{highlight}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div
          ...
          className={`bg-primary/5 rounded-lg p-8 md:p-12 transition-all duration-1000 ease-out ${
            valuePropVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
          }`}
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="heading-1 text-dark mb-4">Why Organizations Choose ThinkRED</h3>
              <p className="text-secondary mb-6">
                Our team's combined expertise spans enterprise leadership, cutting-edge technology, and proven delivery
                at scale. We bring the knowledge and experience to accelerate your digital transformation journey.
              </p>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center">
                  <div className="heading-1 text-primary mb-1">Open Source</div>
                  <div className="text-sm text-secondary">Heritage &amp; Focus</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-secondary">Driven Development</div>
                </div>
                <div className="text-center">
                  <div className="heading-1 text-primary mb-1">Global</div>
                  <div className="text-sm text-secondary">Enterprise Experience</div>
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="bg-white rounded-lg p-6 shadow-regular">
                <h4 className="font-bold text-dark mb-4">Core Differentiators</h4>
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-dark">Enterprise-grade solutions with startup agility</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-5 h-5 text-primary mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path
                    ...
                    <span className="text-sm text-dark">Deep open-source expertise and community leadership</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-5 h-5 text-primary mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path
                    ...
                    <span className="text-sm text-dark">Proven track record at Fortune 500 companies</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-5 h-5 text-primary mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path
                    ...
                    <span className="text-sm text-dark">End-to-end ownership from strategy to delivery</span>
                  </div>
                </div>
              </div>
            </div>
