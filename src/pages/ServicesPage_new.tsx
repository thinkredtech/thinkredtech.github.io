...
const ServicesPage = () => {
  ...
  const { elementRef: pricingRef } = useScrollAnimation();
  const { elementRef: processRef } = useStaggeredAnimation(4, 150);
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1
              className={`font-comfortaa text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-primary via-accent1 to-accent2 bg-clip-text text-transparent transition-all duration-1000 ${
                animateInView
            ...
            <p
              className={`text-xl md:text-2xl text-secondary mb-8 transition-all duration-1000 delay-300 ${
                animateInView
                  ? 'opacity-100 translate-y-0'
                  : 'opacity-0 translate-y-8'
              }`}
            ...
            <div
              className={`flex flex-wrap justify-center gap-3 mb-8 transition-all duration-1000 delay-500 ${
                animateInView
                  ? 'opacity-100 translate-y-0'
                  : 'opacity-0 translate-y-8'
              }`}
      ...
      <section
        ref={pricingRef}
        className="py-16 md:py-24 bg-gradient-to-br from-backgroundAlt to-white"
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Let&apos;s discuss how our expertise can accelerate your business
