        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="max-w-3xl mx-auto text-secondary ">
              Choose the service level that best fits your project requirements
              and budget. All tiers include our commitment to quality and
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-xl border-2 border-primary p-8 relative hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <div className="bg-primary text-white px-4 py-2 rounded-full label-1">
                  Most Popular
                </div>
              </div>
              <div className="text-center mb-6">
                ...
                <p className="text-secondary text-sm mb-4">
                  Ideal for growing businesses and comprehensive projects
                </p>
                <div className="heading-1 text-primary">Contact for Quote</div>
              </div>
              <ul className="space-y-3 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-regular border-2 border-gray-100 p-8 relative hover:shadow-lg transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <p className="text-secondary text-sm mb-4">
                  For large-scale projects requiring maximum support
                </p>
                <div className="heading-1 text-primary">Contact for Quote</div>
              </div>
              <ul className="space-y-3 mb-8">
          ...
          <div className="text-center mt-12">
            <p className="text-secondary mb-6">
              All service tiers include our open-source first approach, modern
        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-xl shadow-regular p-8">
            <div className="text-center max-w-4xl mx-auto">
              <h2 className="heading-1 mb-6 text-secondary">
                Open Source First Approach
              </h2>
              <p className="mb-8 text-secondary">
                At ThinkRED, we prioritize open source solutions wherever
                possible in our development process. Our team has deep roots in
                open source communities including Mozilla, Fedora, and Red Hat,
                bringing this collaborative mindset to every project we deliver.
              </p>
