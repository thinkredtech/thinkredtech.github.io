                    ...
                    <div className="space-y-2">
                      {methodology.activities.map((activity, activityIndex) => (
                        <div key={activityIndex} className="flex items-center justify-center">
                          ...
                          <span className="text-xs text-dark font-medium">{activity}</span>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow-regular p-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    ...
                    <div className="text-xs text-secondary">On-time Delivery</div>
                  </div>
                  <div>
                    <div className="heading-1 text-primary mb-1">95%</div>
                    <div className="text-xs text-secondary">Client Satisfaction</div>
                  </div>
                  <div>
