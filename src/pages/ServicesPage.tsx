          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-secondary mb-6">
                At ThinkRED, we follow a collaborative and transparent approach to ensure that we deliver solutions that meet your specific needs and exceed your expectations.
              </p>
              <div className="space-y-6">
                <div className="flex">
                  ...
                  <div>
                    <h3 className="font-medium text-dark mb-2">Discovery & Planning</h3>
                    <p className="text-secondary">We start by understanding your business goals, requirements, and challenges to create a tailored plan.</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mr-4">
                  ...
                  <div>
                    <h3 className="font-medium text-dark mb-2">Design & Development</h3>
                    <p className="text-secondary">Our team designs and develops solutions using modern technologies and best practices.</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mr-4">
                  ...
                  <div>
                    <h3 className="font-medium text-dark mb-2">Testing & Refinement</h3>
                    <p className="text-secondary">We rigorously test and refine our solutions to ensure quality, performance, and security.</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mr-4">
                  ...
                  <div>
                    <h3 className="font-medium text-dark mb-2">Deployment & Support</h3>
                    <p className="text-secondary">We deploy your solution and provide ongoing support and maintenance to ensure long-term success.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="aspect-w-4 aspect-h-3 bg-backgroundAlt rounded-lg shadow-regular overflow-hidden">
                <div className="inset-0 flex items-center justify-center">
                  <div className="p-8 text-center">
                    ...
                    <p className="text-secondary">Our rigorous quality assurance process ensures that we deliver reliable and high-performing solutions.</p>
                  </div>
                </div>
              </div>
