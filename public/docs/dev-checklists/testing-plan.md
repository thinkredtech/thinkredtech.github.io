...
- [ ] Test on desktop screens (1025px - 1440px width)
- [ ] Test on large screens (1441px and above)
- [ ] Verify all images scale properly
- [ ] Verify text remains readable at all sizes
- [ ] Verify navigation collapses to mobile menu at appropriate breakpoints
...
- [ ] Verify smooth scrolling on in-page links
...
- [ ] Verify filter functionality on Portfolio page
- [ ] Test all dropdown menus
- [ ] Verify scroll animations trigger at appropriate times
...
- [ ] Test avatar visibility on scroll
- [ ] Verify avatar is responsive on all device sizes
...
- [ ] Verify consistent branding throughout site
...
- [ ] Verify site works with JavaScript disabled (graceful degradation)
